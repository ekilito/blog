...
![image-20231028232009299.png](https://bu.dusays.com/2023/10/29/653d31d9160d7.png)
...
> 目的：掌握 [socket.io](http://socket.io/) 的基本使用

1. [socket.io](http://socket.io/) 什么？
   - [socket.io](http://socket.io/) 是一个基于 WebSocket 的 CS（客户端-服务端）的实时通信库
   - 使用它可以在后端提供一个即时通讯服务
   - 它也提供一个 js 库，在前端可以去链接后端的 [socket.io](http://socket.io/) 创建的服务
   - 总结：它是一套基于 websocket 前后端即时通讯解决方案
2. [socket.io](http://socket.io/) 如何使用？
...
3. 剩下的菜单权限控制，是相对复杂一些的
   ...
   ![image-20210309031043592](web/面试/面试加强/02-笔记/images/image-20210309031043592.png)
